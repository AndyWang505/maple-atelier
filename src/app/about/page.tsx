...
export default function AboutPage() {
  return (
    <PageShell width="content" className="space-y-12">
      ...
      >
        <p>
          「選帥選美」一直都是《MapleStory》玩家社群很重要的一部分。大家會花很多時間研究穿搭、配色跟整體風格，互相分享自己角色的造型。以前很多人都用「透視鏡」來試穿搭配，不用真的花楓點，也能先看整套效果，以及參考其他玩家搭配。
        </p>
        <p>
          因此 Maple Atelier 嘗試以現代網頁技術重新實作一套時裝社群工具。你可以在平台上自由試穿時裝、保存自己的搭配，也能分享出去，看看其他玩家分享的搭配，讓時裝搭配文化能以新的形式延續。
        </p>
      </AboutSection>
        ...
        <div className="space-y-5">
          ...
          <FAQ q="模擬器的預覽 / icon 看起來跟遊戲不太一樣？">
            ...
            <p className="text-zinc-600 text-sm sm:text-base leading-relaxed mt-2">
              未來可能會自行解析遊戲的 wz 檔案、實作渲染器來補上 maplestory.io 缺漏的部分，不過工程量浩大，短期內不太可能實現。
            </p>
          </FAQ>
          <FAQ q="我可以儲存幾套搭配？">
